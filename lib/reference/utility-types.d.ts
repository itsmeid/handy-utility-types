 ...
 */
type Fn<Args extends Array<BypassAny> = [], Return = BypassAny> = (...args: Args) => Return;
 ...
 */
type Class<Args extends Array<BypassAny> = [], Return = BypassAny> = {
 ...
 */
type ObjectGeneric<T = BypassAny> = Record<PropertyKey, T>;
 ...
 */
type PartialProps<T, K extends keyof T> = Pick<Partial<T>, K> & Omit<T, K>;
 ...
 */
type ObjectRequiredKeys<T> = T extends ObjectGeneric
	? {
 ...
 */
type ObjectOptionalKeys<T> = T extends ObjectGeneric
	? {
 ...
 */
type ObjectPath<T> = T extends Array<BypassAny>
	? never
 ...
 */
type ObjectPathValue<T, K extends ObjectPath<T> | ''> = K extends ''
	? T
 ...
 */
type ObjectOverwrite<T, U> = Omit<T, keyof U> & U;
 ...
 */
type IsNotEqual<A, B> = IsEqual<A, B> extends false ? true : false;
 ...
 */
type IsObjectLiteral<T> = T extends ObjectGeneric
 ...
 */
type IsClass<T> = Class extends T ? true : false;
 ...
 */
type ExcludeOptional<T> = T extends ObjectGeneric
	? {
 ...
 */
type ExcludeOptionalDeep<T> = T extends ObjectGeneric
	? {
 ...
 */
type ExcludeRequired<T> = T extends ObjectGeneric
	? {
 ...
 */
type ExcludeRequiredDeep<T> = T extends ObjectGeneric
	? {
